...
The second way of replacing missing values, which is called proximity approach, is computationally more expensive but has given better performance than the first, even with large amounts of missing data. 
